<%@ Page Title="" Language="C#" MasterPageFile="~/Game/Resource/Resource.Master" AutoEventWireup="true" CodeBehind="ResourceSn.aspx.cs" Inherits="WebApplication1.Game.Resource.ResourceSn" %>
...
<div class="container-fluid">    
    <div class="row-fluid">
	    ...
	    <div class="span10">
			...
			<p><em>锡是一种在地球存在的稀有矿物，可以用于建设各种设施</em></p>
            <br/>
            <br/>
            <p id ="num1">你目前拥有0个锡矿</p>
            <br/>
			<p id="num2">你目前每秒生产0个锡矿</p> 
...
<script>
    ...
    var sn_r_num_ = 0;
    document.getElementById("num1").innerHTML = "你目前拥有" + sn_r.num + "个锡矿";
    document.getElementById("num2").innerHTML = "你目前每20秒生产" + sn_b.num + "个锡矿";
        /*function checkCookie() {
            al_r.num = getCookie("al_r_num");
            al_b.num = getCookie("al_b_num");
            dosnment.getElementById("num1").innerHTML = "你目前拥有" + al_r.num + "个铝矿";
            dosnment.getElementById("num2").innerHTML = "你目前每10秒生产" + al_b.num + "个铝矿";
        }*/
    //function produce_null() { }
    /*function produce_al_r() {
        var pos = 0;
        dosnment.getElementById("click").className = "btn disabled";
        dosnment.getElementById("click").onclick = function() {produce_null();};
        timeid = setInterval(function () { btn1() }, 10);
        function btn1() {
            if (pos >= 100) {
                clearInterval(timeid);
                dosnment.getElementById("click").innerHTML="点击生产铝矿";
                dosnment.getElementById("click").onclick = function() {produce_al_r();};
                dosnment.getElementById("click").className = "btn";
                al_r.num++;
                dosnment.cookie = "al_r_num="+al_r.num+";path=/";
                dosnment.getElementById("num1").innerHTML = "你目前拥有" + al_r.num + "个铝矿";
            } else {
                pos++;
                dosnment.getElementById("click").innerHTML="点击生产铝矿（冷却中）";
            }
        }  
    }*/
    function btn2() {
